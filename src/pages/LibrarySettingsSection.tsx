import { ArrowDown, ArrowUp, ChevronDown, Clock, Download, FolderPlus, GripVertical, RefreshCw, Trash2, X } from 'lucide-react';
import { Button } from '@/components/ui/button';
import { Card, CardContent, CardDescription, CardHeader, CardTitle } from '@/components/ui/card';
import { SIDEBAR_NAV_LABELS, type SidebarNavItemId } from './Settings.helpers';
import type { LibraryFolderSection } from './Settings.types';
