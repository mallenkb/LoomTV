...
LoomTV is a local-first desktop media library and player. It works with local files, local network workflows, metadata provider credentials, bundled media tooling, and desktop update flows. Security reports are taken seriously because a small desktop app still has access to sensitive local resources.
...
- Steps to reproduce
- Affected platform and LoomTV version or commit
