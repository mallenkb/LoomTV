# Loom Media Server 1.0.5 Release Notes

Loom Media Server 1.0.5 focuses on making the first-run library flow and library sync reliable in the installed desktop app.

![Loom Media Server empty library home screen](../screenshots/loomtv-home-empty-library.svg)
