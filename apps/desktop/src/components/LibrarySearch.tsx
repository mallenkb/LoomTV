  ...
  return (
    <div className="loom-library-search pointer-events-none fixed left-48 right-0 top-4 z-40 flex justify-center px-4">
      <div className="loom-library-search-inner flex w-full max-w-3xl items-center justify-center gap-2">
        <div className="loom-no-drag pointer-events-auto flex h-12 min-w-0 flex-1 items-center gap-3 rounded-lg border border-[var(--loom-control-border)] bg-[var(--loom-panel)] px-4 text-[var(--loom-text)] shadow-[0_16px_42px_rgba(0,0,0,0.18)] backdrop-blur-md transition-colors">
