...
export const rendererSettingsPatchSchema: z.ZodType<SettingsPayload> = z.object({
  ...
  otherFolderGroups: z.record(z.string(), z.object({
    ...
    icon: z.enum(['folder', 'archive', 'clapperboard', 'gamepad', 'music', 'camera', 'graduation', 'fitness', 'travel', 'family', 'heart', 'star']),
    folders: z.array(z.string().trim().min(1)),
  })).optional(),
  otherFolderIcon: z.enum(['folder', 'archive', 'clapperboard', 'gamepad', 'music', 'camera', 'graduation', 'fitness', 'travel', 'family', 'heart', 'star']).optional(),
...
export function settingsForRenderer(settings: AppSettings): SettingsPayload {
  return {
    ...
    organizeFilesAfterSync: settings.organizeFilesAfterSync,
    ...
    otherFolderGroups: settings.otherFolderGroups,
    otherFolderIcon: settings.otherFolderIcon,
